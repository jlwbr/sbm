module emulator
    function pop_or_error(Array)
        if size(Array, 1) < 1
            Main.error("Runtime error, tried to pop non existing element from the stack", 1)
        end
